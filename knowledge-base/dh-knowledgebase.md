...
- **P2 (UX)**: Required fields first · mention default values in `help` & apply fallbacks in perform code (avoid `defaultValue` key in input JSON) · hide complexity (auto-detect format).
